...
//getting the results
    ...
    function getLastMonth(type,url){
    ...
    function generateTimeSerial(start, end) {
        ...
        //get the start and end days for 30 days ago
        startLast=new Date(date.getTime()-30*24*60*60*1000);
        endLast=new Date(end.getTime()-30*24*60*60*1000);
