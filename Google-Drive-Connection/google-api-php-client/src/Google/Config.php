...
class Google_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'application_name' => 'publish to wordpress',
      ...
      'classes' => array(
        ...
        'Google_Auth_OAuth2' => array(
          ...
          'client_id' => '413089939333-b69ldlscjjqscbbjjddtkuq92l8ar4u4.apps.googleusercontent.com',
          'client_secret' => 'ah45qegsTsEBPA_TkPvIzjTq',
          'redirect_uri' => '',

          // Simple API access key, also from the API console. Ensure you get
          // a Server key, and not a Browser key.
          'developer_key' => 'AIzaSyDUeK1pRddKoqz7CVWF514gKQRdrozIob8',

          // Other parameters.
          'hd' => '',
          'prompt' => '',
          'openid.realm' => '',
          'include_granted_scopes' => array('https://www.googleapis.com/auth/drive.readonly','https://www.googleapis.com/auth/drive'),
          'login_hint' => '',
