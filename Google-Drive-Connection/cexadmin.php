 ...
 * Author: Xin Wang and George Ulloa
 */
function cexdrive_settings_page()
{
    ...
    //check if user selects a doc to convert
    if (isset($_GET['DocId'])) {
    ...
    <div class="wrap">
        ...
        <h4>Click on the <img src='DrivePluginIcons/convert.png'> icon to convert your document into a Wordpress draft.
        </h4>
...
<?php else: ?>
            ...
            <ol>
                <li><?php echo $settings->email; ?><a
                        href="<?php echo $url; ?>&remove=<?php echo urlencode($settings->email); ?>">(Remove)</a></li>
            </ol>
            ...
            $files_list = $service->files->listFiles(array())->getItems(); ?>
            <ol>
